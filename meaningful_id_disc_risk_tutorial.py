...
'''
Usage: synthetic_risk_model_reid.py [model_id] [ckpt_id] [theta] [original_filename] [pop_filename] [output_directory] [n_phe_qid]
Example: meaningful_id_disc_risk_tutorial.py 21 best 0.05 train_vumc pop_vumc result/ 7
1. [model_id]: model id. Default: 'real'.
2. [ckpt_id]: checkpoint id. Default: 'best'.
...
6. [output_directory]: output directory. Default: 'Results_Synthetic_VUMC/'.
7. [n_phe_qid]: the number of phenotypic qids (most common diseases). An integer in [0, 10]. Default: '7'.
'''
